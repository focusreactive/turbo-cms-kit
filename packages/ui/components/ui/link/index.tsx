...
export const LinkVariantsClassNames: ILinkVariantsClassNames = {
  [LinkVariant.Primary]: "inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900",
...
export const Link: React.FC<LinkProps> = (
  ({ text, href, className, variant = LinkVariant.Primary }) => {
    return (
      <NextLink
        href={href}
